...
public class Tokens {
    ...
    public static final String STRING_CONSTANT_PATTERN = "^\"[a-zA-Z0-9 _:;!?.+/%*&#<>=^-]*\"$";
    public static final String BOOLEAN_CONSTANT_PATTERN = "^true|false$";

    public static boolean isIdentifier(String token) {
        FiniteAutomaton finiteAutomaton = new FiniteAutomaton("src/finiteAutomaton/FA_identifiers.in");
        return finiteAutomaton.isAcceptedSequence(token);
    }
    ...
    public static boolean isIntegerConstant(String token) {
        FiniteAutomaton finiteAutomaton = new FiniteAutomaton("src/finiteAutomaton/FA_integer_constant.in");
        return finiteAutomaton.isAcceptedSequence(token);
    }
