...
public class SymbolTable {
    ...
    public Pair<Integer, Integer> getSymbolPosition (String symbol) {
         ...
         * @param symbol
         *
         * @retrun a symbolTable.Pair if symbol exists in the symbol table or null otherwise
         *
         */
    ...
    public String toString() {
         ...
         *
         */
        StringBuilder str = new StringBuilder("symbolTable.SymbolTable{" + "capacity=" + capacity + "\n");
        for(int i = 0; i < this.capacity; i++) {
            str.append(i).append(": ");
            if(this.hashTable[i] == null)
                str.append("[]");
